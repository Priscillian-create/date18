    ...
    saveDataToSupabase: async (table, data, id = null) => {
      ...
      if (navigator.onLine) {
        try {
          ...
          if (table === 'inventory') {
            const { section, name, price, cost, stock, expiry_date,
              description, status, created_by, created_at,
              updated_by, updated_at, deleted, deleted_at } = dataForSupabase;
            ...
            // ONLY include columns that exist in your sales table
            const {
              user_id, user_email, section, items, subtotal, total,
              totalCost, totalProfit, payment_method,
            ...
            // ONLY include columns that exist in your sales_data table
            const {
              id, totalSales, totalTransactions, topItem,
              dailySales, dailyTransactions, profit
            } = dataForSupabase;
            ...
            // ONLY include columns that exist in your user_data table
            const {
